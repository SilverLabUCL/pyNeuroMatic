...
class TestRunToolPerChannelGrouping(unittest.TestCase):
    ...
    def setUp(self):
        ...
        ra0 = self.folder.data.new("RecordA0")
        ra1 = self.folder.data.new("RecordA1")
        rb0 = self.folder.data.new("RecordB0")
        rb1 = self.folder.data.new("RecordB1")
        self.ds.channels.get("A").data.append(ra0)
        self.ds.channels.get("A").data.append(ra1)
        self.ds.channels.get("B").data.append(rb0)
        self.ds.channels.get("B").data.append(rb1)
        self.ds.epochs.get("E0").data.append(ra0)
        self.ds.epochs.get("E0").data.append(rb0)
        self.ds.epochs.get("E1").data.append(ra1)
        self.ds.epochs.get("E1").data.append(rb1)
