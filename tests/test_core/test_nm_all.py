...
import tests.test_core.nm_channel_test as nm_channel_test
import tests.test_core.nm_data_test as nm_data_test
import tests.test_core.nm_dataseries_test as nm_dataseries_test
import tests.test_core.nm_dimension_test as nm_dimension_test
import tests.test_core.nm_epoch_test as nm_epoch_test
import tests.test_core.nm_folder_test as nm_folder_test
import tests.test_core.nm_manager_test as nm_manager_test
import tests.test_core.nm_object_test as nm_object_test
import tests.test_core.nm_object_container_test as nm_object_container_test
import tests.test_core.nm_project_test as nm_project_test
import tests.test_core.nm_sets_test as nm_sets_test
import tests.test_core.nm_utilities_test as nm_utilities_test
