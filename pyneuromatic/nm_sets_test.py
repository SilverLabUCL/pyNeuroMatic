...
class NMSetsTest(unittest.TestCase):
    ...
    def test00_init(self):
        ...
        self.assertEqual(list(self.sets0_copy._nmobjects_dict.keys()),
                         ONLIST0)
        ...
        self.assertEqual(list(self.sets1._nmobjects_dict.keys()),
                         ONLIST1)
        ...
        self.assertEqual(list(self.sets1_copy._nmobjects_dict.keys()),
                         ONLIST1)
    ...
    def test03_getitem(self):
        ...
        for d in self.sets0_init:
            ...
            if eqlist:
                ...
                eqlist_g = self.sets0.get(sname, default='test',
                                          get_equation=True)
                self.assertEqual(olist, eqlist_g)
    ...
    def xtest04_setitem(self):
        ...
        self.assertEqual(self.sets0.get(sname0, get_keys=True),
                         [ONLIST0[1]])  # last item overwrites
